...
<div>
    ...
    .imf #carousel-1:checked~.control-1~.carousel-indicators li:nth-child(1) .carousel-bullet,
        ...
        <div class="carousel relative shadow-2xl bg-white">
            <div class="carousel-inner relative overflow-hidden w-full">
                ...
                <div class="carousel-item absolute opacity-0" style="height:80vh;">
                    ...
                    <div>
                        <img src="https://cdn.pixabay.com/photo/2021/03/25/14/00/horse-6123173_960_720.jpg" width="100%"
                            alt="">
                    </div>
                </div>
                ...
                <div class="carousel-item absolute opacity-0" style="height:80vh;">
                    ...
                    <div>
                        <img src="https://cdn.pixabay.com/photo/2014/10/06/17/30/child-476507_960_720.jpg" width="100%"
                            alt="">
                    </div>
                </div>
                ...
                <div class="carousel-item absolute opacity-0" style="height:80vh;">
                    ...
                    <div>
                        <img src="https://media.istockphoto.com/photos/flowers-composition-magnolia-flowers-on-pastel-blue-background-flat-picture-id1137409428?k=6&m=1137409428&s=612x612&w=0&h=K4uzS_kms_jw3UA9ufnX-Y1tvcAHhwNba7GiLmADE1M="
                            width="100%" alt="">
                    </div>
                </div>
                <label for="carousel-2"
